...
For more details about the API, and until [pkg.go.dev](https://pkg.go.dev/github.com/mariomac/iters), 
...
import (
  "fmt"
  "github.com/mariomac/iters/stream"
)
...
goos: darwin
goarch: amd64
pkg: github.com/mariomac/iters/stream
